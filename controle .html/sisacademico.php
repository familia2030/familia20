  ...
  <div class="container-fluid bg-primary" style="min-height: 100vh; display: flex; flex-direction: column;">
    ...
    <nav class="navbar navbar-expand-sm bg-light rounded-3 sticky-top mb-3">
      <div class="container-fluid">
        <a class="navbar-brand" href="sisacademico.php">Sistema Acadêmico</a>
          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <?php
                $menu = [
                  'Cadastro de alunos' => 'cadastrodealunos',
                ...
                foreach ($menu as $item => $pagina) {
                  echo '<li><a class="dropdown-item" href="sisacademico.php?pagina=' . $pagina . '">' . $item . '</a></li>';
                }
                ?>
              </ul>
            </li>
